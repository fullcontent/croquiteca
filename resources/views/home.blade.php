  ...
  <body>
    ...
    <nav class="navbar navbar-inverse bg-inverse navbar-toggleable-md fixed-top">
      <div class="container">
        ...
        <a class="navbar-brand" href="#"><img src="http://diylogodesigns.com/blog/wp-content/uploads/2016/02/twitter-app-logo-png.png" alt="" width="50">Croquiteca</a>
    ...
    <div class="container">
      ...
      <div class="col-6 col-md-3 sidebar-offcanvas" id="sidebar">
        ...
        <div class="col-12 col-md-9">
          ...
          <div class="row __reader_view_article_wrap_15600862945936012__">
