<?php namespace App\Http\Controllers;
	...
	class AdminSectorsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Localização","name"=>"location_id","join"=>"locations,nome"];
			...
			//$this->form[] = ["label"=>"ComoChegar","name"=>"comoChegar","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			...
			//$this->form[] = ["label"=>"Imagem","name"=>"imagem","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
